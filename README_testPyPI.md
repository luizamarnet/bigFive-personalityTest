...
>
>We have started running automated tests across several Python versions. However, at this stage, most of the package's functionality has only been tested with Python 3.10. If you encounter problems with another Python version, we recommend using Python 3.10.
